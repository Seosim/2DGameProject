...
class Player(Sprite):
    ...
    def getScreenX(self):
        ...
        if width / 2 > self.posX:
            ...
            self.screenX = width / 2

    def Show(self):
        self.image.clip_draw(self.i_w * (self.hitframe + int(self.frame)),
                             self.i_h * self.action, self.i_w, self.i_h,
                             self.screenX, self.posY - self.cameraY,
                             self.w, self.h)
